---
title: "Module 3: Programming Tools"
description: "Write your own functions, use loops to repeat computations, and use conditionals to make decisions in your code."
sidebar:
  order: 3
---
